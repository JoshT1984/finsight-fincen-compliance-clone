...
public class CaseNoteService {
	...
	public CaseNoteService(CaseNoteRepository repo, CaseFileRepository caseFileRepo, DocumentRepository documentRepo,
	...
	public CaseNoteResponse create(CreateCaseNoteRequest dto) {
		...
		// Emit event for case note created
		eventEmitter.emit(
	...
	public CaseNoteResponse updateById(Long noteId, UpdateCaseNoteRequest request) {
		...
		// Emit event for case note updated
		eventEmitter.emit(
				DocumentEventLog.caseNoteUpdated(
						saved.getNoteId().toString(),
						SecurityContextUtils.getCurrentUserId().orElse(null).toString(),
						Map.of(
								"caseId", saved.getCaseId(),
	...
	public void deleteById(Long noteId) {
		...
		// Emit event for case note deleted
		eventEmitter.emit(
				DocumentEventLog.caseNoteDeleted(
						caseNote.getNoteId().toString(),
						SecurityContextUtils.getCurrentUserId().orElse(null).toString(),
						Map.of(
								"caseId", caseNote.getCaseId(),
								"authorUserId", caseNote.getAuthorUserId(),
								"noteText", caseNote.getNoteText(),
