    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationConverter jwtAuthenticationConverter)
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/suspects/**", "/api/aliases/**", "/api/addresses/**", "/api/organizations/**")
                        .hasAnyRole("ANALYST", "LAW_ENFORCEMENT_USER", "COMPLIANCE_USER")
                        .requestMatchers("/api/suspects/**", "/api/aliases/**", "/api/addresses/**", "/api/organizations/**")
                        .hasAnyRole("ANALYST", "LAW_ENFORCEMENT_USER")
